...
auto create(size_t n, Args&&... args) {
	if constexpr(sizeof...(args) == 1) return vector(n, args...); else return vector(n, create(args...));
}
...
template <typename T1, typename T2> istream& operator>>(istream& istream, pair<T1, T2>& p) {
